...
export default function CS({ jdId, selectedFile, onClose }) { // Updated props to match resume version
  ...
  useEffect(() => {
    ...
    if (selectedFile) {
      ...
      handleAnalysisComplete({
        file: selectedFile,
        type: 'job-description' // Kept for JD context
      });
    }
  }, [jdId, selectedFile]); // Updated dependencies to match resume version
              ...
              <div className="flex relative">
                ...
                <div style={{ width: '100%', clear: 'both' }}>
                  <span style={{ paddingLeft: '34px', fontSize: '20px' }}>
                    JD {jdId} {/* Updated to display jdId dynamically */}
                  </span>
