...
import ResumePage from './page'; // Make sure this path is correct

const DrawerNavigation = ({ selectedResume, onClose, isOpen }) => {
  ...
  if (!isOpen || !selectedResume) return null;
  ...
  return (
    <>
      ...
      <div
        ...
        className={`fixed top-0 right-0 z-40 p-4 overflow-y-auto transition-transform`}
        style={{
          display: 'block',
          marginTop: '136px',
      ...
      >
        ...
        >
          Resume Details - {selectedResume.rollName}
        </h5>
