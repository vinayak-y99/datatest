...
import JDPage from './page'; // Make sure this path is correct to your JDPage component

const DrawerNavigationJD = ({ selectedJd, onClose }) => {
  const [isMaximized, setIsMaximized] = useState(false);
  const [isModalOpen, setIsModalOpen] = useState(false);
  const [drawerWidth, setDrawerWidth] = useState(window.innerWidth * 0.6); // Changed from 320 to 60% of window width
  ...
  // Only render if selectedJd exists (controlled by JDTab)
