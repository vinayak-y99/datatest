...
export default function CS({ resumeId, selectedFile, onClose }) {
  ...
  const [isPageVisible, setIsPageVisible] = useState(true); // Controls visibility of this page
  ...
  useEffect(() => {
    ...
    if (selectedFile) {
      ...
      handleAnalysisComplete({
        file: selectedFile,
        type: 'resume' // Adjust type as needed
      });
    }
  }, [resumeId, selectedFile]);
              ...
              <div className="flex relative">
                ...
                <div style={{ width: '100%', clear: 'both' }}>
                  <span style={{ paddingLeft: '34px', fontSize: '20px' }}>
                    Resume {resumeId} {/* Display resumeId for clarity */}
                  </span>
