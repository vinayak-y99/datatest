...
export default function CS({ jdId, selectedFile, onClose }) { // Updated props to include jdId and onClose
  ...
  const [viewItems, setViewItems] = useState([]); // Fixed casing from ViewItems
  const [showProjectDashboard, setShowProjectDashboard] = useState(false); // Renamed for consistency
  ...
  useEffect(() => {
    ...
    if (selectedFile) {
      ...
      handleAnalysisComplete({
        file: selectedFile,
        type: 'job-description' // Kept as job-description for context
      });
    }
  }, [jdId, selectedFile]); // Updated dependencies to include jdId
              ...
              <div className="flex relative">
                ...
                <div style={{ width: '100%', clear: 'both' }}>
                  <span style={{ paddingLeft: '34px', fontSize: '20px' }}>
                    JD {jdId} {/* Updated to display jdId instead of "Coding" */}
                  </span>
