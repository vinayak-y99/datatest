...
import ResumePage from './page'; // Make sure this path is correct to your ResumePage component

const DrawerNavigationJD = ({ selectedResume, onClose }) => {
  const [isMaximized, setIsMaximized] = useState(false);
  const [isModalOpen, setIsModalOpen] = useState(false);
  const [drawerWidth, setDrawerWidth] = useState(window.innerWidth * 0.6); // Changed from 320 to 50% of window width
  ...
  // Only render if selectedResume exists (controlled by JDTab)
  ...
  return (
    <>
      ...
      <div
        ...
        style={{
          display: 'block', // Always block when rendered, visibility controlled by parent
          marginTop: '136px',
